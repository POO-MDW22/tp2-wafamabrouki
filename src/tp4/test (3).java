...
public class test {
    public static void main(String[] args) {
        ...
        Produit product1 =new Produit(4021,"Lait","nitalait",0,date);
        Produit product2 =new Produit(3510,"Yaourt","Vitalait",0,date);
        Produit product3 =new Produit(2250,"hrissa","Sicam",1.200,date);
